...
- **PIPE Interface Specification:** `docs/reference/pipe-interface-spec.md`
...
- See: `docs/phases/phase-5-completion-summary.md`, `docs/archive/2025-10-17-phase-4-cleanup-and-documentation.md`
...
- See: `docs/phases/phase-6-completion-summary.md`, `docs/archive/2025-10-17-phase-6-ltssm-link-training.md`
